  ...
  def main(args: Array[String]): Unit = {
    ...
    val nn =
      ShrinkAndSharpen(cut = .4) !!
        AutoUpdatingConv("Conv", ConvParameters(5, 5, 14, 14, 20, 3e-3, params.SEED)) !!
        Relu() !!
        AutoUpdatingAffine("affine1", new L2RegAffineParameters(2000, 1000, 1e-3, 0.0, params.SEED)) !!
        Relu() !!
        AutoUpdatingAffine("affine2", new L2RegAffineParameters(1000, 200, 1e-3, 0.0, params.SEED)) !!
        Relu() !!
        AutoUpdatingAffine("affine3", new L2RegAffineParameters(200, 10, 1e-4, 0.0, params.SEED)) !!
